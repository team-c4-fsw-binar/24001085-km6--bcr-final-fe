...
import garuda from "../../assets/garuda-indonesia-logo.png";
import koper from "../../assets/koper.png";
import empty from "../../assets/pencarian_empty.png";
import loading from "../../assets/pencarian_loading.png";
import habis from "../../assets/tiket_habis.png";
        ...
        <Row className="scrollable">
          {isTiketHabis ? (
            <Col className="text-center mt-5">
              <Image src={habis} className=""></Image>
